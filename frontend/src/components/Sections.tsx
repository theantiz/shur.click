...
export default function Sections() {
  return (
    <>
      <section id="features" className="mx-auto mt-14 w-full max-w-6xl sm:mt-16">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-slate-900 sm:text-3xl">Why choose shur.click</h2>
        </div>
      ...
      <section id="how" className="mx-auto mt-10 w-full max-w-6xl sm:mt-12">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-slate-900 sm:text-3xl">How it works</h2>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 sm:p-6">
          <h3 className="text-lg font-semibold text-slate-900 sm:text-xl">Simple workflow, fast output</h3>
      ...
      <section id="plans" className="mx-auto mt-10 w-full max-w-6xl sm:mt-12">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-slate-900 sm:text-3xl">Plans</h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <article className="rounded-2xl border border-teal-200 bg-teal-50/70 p-5">
            ...
            <h4 className="mt-1 text-xl font-semibold text-slate-900">$2 / month</h4>
            <p className="mt-2 text-sm text-slate-700">Unlimited link creation with the same dashboard workflow and billing support.</p>
          </article>
        </div>
      </section>
    </>
